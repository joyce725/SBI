...
<div id="accordion" >
  ...
  <div style="padding: 0px 0px 0px 10px;">
    <ul>
		...
		<li><a href="customer.jsp" target="main_page" style="width: auto;">客戶管理</a></li>
...
<!--     	<li><a href="404.jsp" target="main_page">進貨報表</a></li> -->
<!--     	<li><a href="404.jsp" target="main_page">進貨退回報表</a></li> -->
<!--     	<li><a href="404.jsp" target="main_page">庫存管理報表</a></li> -->
<!--     	<li><a href="404.jsp" target="main_page">供應商報表</a></li> -->
